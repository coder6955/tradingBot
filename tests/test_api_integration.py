...
class ApiIntegrationTests(unittest.TestCase):
    ...
    def test_dashboard_renders_trader_cockpit_sections(self) -> None:
        ...
        self.assertIn("Bank Nifty Operator Dashboard", html)
        self.assertIn("Operational truth", html)
        self.assertIn("Critical Runtime", html)
        self.assertIn("Action Required", html)
        self.assertIn("Today’s Risk &amp; Trading", html)
        self.assertIn("Open Trades &amp; Exit Alerts", html)
        self.assertIn("Setup &amp; Armed Entry", html)
        self.assertIn("Market Data Health", html)
        self.assertIn("Research &amp; Notifications", html)
        self.assertIn("Recent Decisions", html)
        self.assertIn("Useful Details", html)
        self.assertIn("/research/after-market/status", html)
        self.assertIn("/alerts/status", html)
        self.assertIn("const DASHBOARD_REFRESH_MS = 15000;", html)
        self.assertIn("const DASHBOARD_SLOW_REFRESH_MS = 60000;", html)
        ...
        self.assertIn("operator_state", html)
        self.assertIn("execution_profile", html)
        self.assertIn("exit_executable_price", html)
        self.assertNotIn("V5 Strategy", html)
        self.assertNotIn("Quick Modules", html)
        self.assertNotIn("Raw Details", html)

    def test_alert_status_is_read_only_and_secret_free(self) -> None:
