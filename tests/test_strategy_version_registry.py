...
class StrategyVersionRegistryTests(unittest.TestCase):
    ...
    def test_current_version_is_registered_with_human_purpose_snapshot(self) -> None:
        ...
        self.assertEqual(version["config_snapshot"]["entry_filters"]["min_signal_score"], 80)
        self.assertIn("purpose", version["settings_purpose"]["entry_filters"]["min_signal_score"])

    def test_same_version_with_changed_config_flags_drift_without_overwriting_original(self) -> None:
        registry = StrategyVersionRegistry()
