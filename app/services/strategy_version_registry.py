...
SETTING_PURPOSES: dict[str, str] = {
    ...
    "live_option_candle_backfill_market_open_on_first_seen": "When a newly relevant option has no early candles, starts live catch-up from market open instead of only a short lookback.",
    "live_option_candle_backfill_session_start_time": "Session start used for option-candle first-seen backfill, normally NSE option market open.",
    "live_option_candle_backfill_max_historical_calls_per_run": "Hard cap on Kite historical API calls per live catch-up cycle to reduce rate-limit risk.",
    ...
    "enable_websocket_candle_context_recovery": "Restores in-memory premium candle context from stored current-session candles after restart/backfill without replaying fake ticks.",
    "websocket_candle_context_recovery_lookback_minutes": "Maximum current-session candle lookback used when seeding WebSocket premium candle memory after restart.",
    ...
    def current_config_snapshot(self) -> dict[str, Any]:
        return {
            ...
            "entry_timing": self._values(
                ...
                "enable_normalized_entry_chase",
                "normalized_entry_chase_lookback_ticks",
                "normalized_entry_chase_max_atr",
                "fast_rally_window_seconds",
            ...
            "data_policy": self._values(
                ...
                "banknifty_prewarm_strike_depth",
                "banknifty_prewarm_overlap_seconds",
                "enable_underlying_candle_pipeline",
                "underlying_candle_symbol",
                "enable_raw_tick_capture",
            ...
            "learning_guards": self._values(
                ...
                "rejected_outcome_horizon_minutes",
                "setup_episode_window_seconds",
                ...
                "live_option_candle_backfill_market_open_on_first_seen",
                "live_option_candle_backfill_session_start_time",
                ...
                "walk_forward_min_train_candles",
                "walk_forward_min_validation_candles",
